    ...
    <div class="row mt-5">
        <div class="col-md-4">
            ...
            <table class="table">
                ...
                <tr>
                    <td>Client</td>
                    <td><b><?php echo e($project->hasRequirement->client->name??'N/A'); ?></b></td>
                </tr>
            </table>
        </div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\qixer-master\resources\views/frontend/user/seller/activity/current-project-details.blade.php ENDPATH**/ ?>