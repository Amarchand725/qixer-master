                            ...
                            <div class="tab-content margin-top-40">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name"
                                           value="{{$project->hasProjectDetail->name}}" placeholder="{{__('Name')}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="project_manager_id" id="project_manager_id">
                                        <option value="{{$project->hasRequirement->project_manager_id}}">{{$project->hasRequirement->project_manager->name}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="timeline" id="timeline"
                                           value="{{$project->hasProjectDetail->timeline}}" placeholder="{{__('Project Timeline')}}">
                                </div>
