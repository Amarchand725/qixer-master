...
<div class="dashboard-service-single-item border-1 margin-top-40">
    <div class="row">
        @php $counter = 1; $bool = true; @endphp 
                ...
                <div class="card"> 
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            @if(!empty($project_detail->hasPayment))
                            ...
                            @else 
                                @if(empty($project_detail->hasPayment) && $bool)
                                    @php $bool = false @endphp 
                                    <tr>
                                        <td colspan="2" style="text-align:center">
                                            <button class="btn btn-success btn-sm fund-btn" data-amount="{{ $project_detail->total_cost }}" data-project-id="{{ $project_detail->project_id }}" value="{{ $project_detail->id }}">Fund Now</button>
                                        </td>
                                    </tr>
                                @endif
                            @endif
    ...
    <div class="row mt-5">
        <div class="col-md-4">
            ...
            <table class="table">
                ...
                <tr>
                    <td>Seller</td>
                    <td><b>{{ $project->hasSeller->name??'N/A' }}</b></td>
                </tr>
            </table>
        </div>
    </div>
